            ...
            carColorsDiv.append(`<div class="rounded border border-3 p-5 mb-4" id="color-${lastSelectedColorId}">
                                                ...
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-md-4 fv-row">
                                                        ...
                                                        <div class="rounded-circle w-80px h-80px m-auto" style="border:1px solid lightslategrey;background:${ selectedColor['hex_code'] ?? `url(${getImagePath('Colors',selectedColor['image'])})` }"></div>
...
let openImagesModal = ( type , colorId) => {
    ...
    images.forEach( ( image ) => {
        ...
        $("#images-container").append(`
                ...
                <div class="image-input-wrapper w-100px h-100px" style="background-image: url('${ getImagePath('Cars',image)}'); background-size:contain;"></div>
