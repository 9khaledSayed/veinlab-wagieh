        ...
        <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" data-control="select2" name="slider_ar" data-placeholder="{{ __("Choose the slider") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                            <option value="" selected ></option>
                            {{-- @foreach( $sliders as $slider)
                                <option {{ settings()->get('slider_ar') == $slider->alias ? 'selected' : '' }} value="{{ $slider->alias }}"> {{ $slider->title }} </option>
                            @endforeach --}}
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" data-control="select2" name="slider_en" data-placeholder="{{ __("Choose the slider") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                            <option value="" selected ></option>
                            {{-- @foreach( $sliders as $slider)
                                <option {{ settings()->get('slider_en') == $slider->alias ? 'selected' : '' }} value="{{ $slider->alias }}"> {{ $slider->title }} </option>
                            @endforeach --}}
                        </select>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Purchase Order text in home page in arabic") }}</label>
                        <textarea id="tinymce_purchase_order_text_in_home_page_ar" name="purchase_order_text_in_home_page_ar" class="tinymce">{!! settings()->get('purchase_order_text_in_home_page_ar') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="purchase_order_text_in_home_page_ar"></p>
                    ...
                    <!-- Begin :: Col -->
                        <div class="col-md-6">
                            ...
                            <label class="form-label">{{ __("Purchase Order text in home page in english") }}</label>
                            <textarea id="tinymce_purchase_order_text_in_home_page_en" name="purchase_order_text_in_home_page_en" class="tinymce">{!! settings()->get('purchase_order_text_in_home_page_en') ?? '' !!}</textarea>
                            <p class="text-danger error-element" id="purchase_order_text_in_home_page_en"></p>
        ...
        <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Contact us section photo") }}</label>
                        <br>
                        <input type="file" accept="image/*" class="d-none" name="contact_us_section_photo" id="contact_us_section_photo-uploader">
                        <button class="btn btn-secondary w-100 image-upload-inp" type="button" > <i class="bi bi-upload fs-8" ></i> {{ settings()->get('contact_us_section_photo') ?:  __("no file is selected")   }} </button>
                        <p class="invalid-feedback" id="contact_us_section_photo" ></p>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <label class="form-label">{{ __("purchase section photo") }}</label>
                    <br>
                    <input type="file" accept="image/*" class="d-none" name="purchase_section_photo" id="purchase_section_photo-uploader">
                    <button class="btn btn-secondary w-100 image-upload-inp" type="button" > <i class="bi bi-upload fs-8" ></i> {{ settings()->get('purchase_section_photo') ?:  __("no file is selected")   }} </button>
                    <p class="invalid-feedback" id="purchase_section_photo" ></p>
                    ...
                    <label class="form-label">{{ __("who tempelet section photo") }}</label>
                    <br>
                    <input type="file" accept="image/*" class="d-none" name="who_tempelet_photo" id="who_tempelet_photo-uploader">
                    <button class="btn btn-secondary w-100 image-upload-inp" type="button" > <i class="bi bi-upload fs-8" ></i> {{ settings()->get('who_tempelet_photo') ?:  __("no file is selected")   }} </button>
                    <p class="invalid-feedback" id="who_tempelet_photo" ></p>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet Cars in arabic") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_ar" name="why_tempelet_cars_ar" class="tinymce">{!! settings()->get('why_tempelet_cars_ar') ?? '' !!}</textarea>
                        <p class="text-danger invalid-feedback" id="why_tempelet_cars_ar"></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet Cars in english") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_en" name="why_tempelet_cars_en" class="tinymce">{!! settings()->get('why_tempelet_cars_en') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="why_tempelet_cars_en"></p>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet cars card 1 in arabic") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_card_1_ar" name="why_tempelet_cars_card_1_ar" class="tinymce">{!! settings()->get('why_tempelet_cars_card_1_ar') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="why_tempelet_cars_card_1_ar"></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet cars card 1 in english") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_card_1_en" name="why_tempelet_cars_card_1_en" class="tinymce">{!! settings()->get('why_tempelet_cars_card_1_en') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="why_tempelet_cars_card_1_en"></p>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet cars card 2 in arabic") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_card_2_ar" name="why_tempelet_cars_card_2_ar" class="tinymce">{!! settings()->get('why_tempelet_cars_card_2_ar') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="why_tempelet_cars_card_2_ar"></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet cars card 2 in english") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_card_2_en" name="why_tempelet_cars_card_2_en" class="tinymce">{!! settings()->get('why_tempelet_cars_card_2_en') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="why_tempelet_cars_card_2_en"></p>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet cars card 3 in arabic") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_card_3_ar" name="why_tempelet_cars_card_3_ar" class="tinymce">{!! settings()->get('why_tempelet_cars_card_3_ar') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="why_tempelet_cars_card_3_ar"></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __("Why tempelet cars card 3 in english") }}</label>
                        <textarea id="tinymce_why_tempelet_cars_card_3_en" name="why_tempelet_cars_card_3_en" class="tinymce">{!! settings()->get('why_tempelet_cars_card_3_en') ?? '' !!}</textarea>
                        <p class="text-danger error-element" id="why_tempelet_cars_card_3_en"></p>
