...
@endpush
@section('title')  {{ __("Archives") }} @endsection
...
@section('content')
    @component('components.dashboard.breadcrumb')
        ...
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('Archives')}}</li><!-- end   :: Item -->
    @endcomponent
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <!-- begin :: Archieve  -->
                    <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0"></div><!-- end   :: Archieve  -->
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/waiting-labs-archives.js') }}"></script>
    <script>
