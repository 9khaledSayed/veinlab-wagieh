...
@section('title')  {{ __("Finished Analysis") }} @endsection
...
@component('components.dashboard.breadcrumb')
    ...
    @endslot
    <!-- begin :: Item -->
    <li class="breadcrumb-item text-muted">{{__('Finished Analysis')}}</li><!-- end   :: Item -->
@endcomponent
...
<script src="{{ asset('js/dashboard/datatables/finished-waiting-labs.js') }}"></script>
<script>
