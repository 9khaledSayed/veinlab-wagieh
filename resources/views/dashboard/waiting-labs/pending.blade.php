...
@section('title')  {{ __("Pending Analysis") }} @endsection
...
@section('content')
    @component('components.dashboard.breadcrumb')
        ...
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('Pending Analysis')}}</li><!-- end   :: Item -->
    @endcomponent
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/pending-waiting-labs.js') }}"></script>
    <script>
