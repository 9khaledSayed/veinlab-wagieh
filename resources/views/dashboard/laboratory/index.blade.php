...
@endpush
@section('title') {{__("laboratories list")}} @endsection

@section('content')

    @component('components.dashboard.breadcrumb')
        @slot('breadcrumb_title')
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("laboratories") }}</h1><!-- end   :: Title -->
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('laboratories list')}}</li><!-- end   :: Item -->
    @endcomponent
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                @can('create_laboratories')
                    <!-- begin :: Add Button -->
                        <a href="{{ route('dashboard.laboratories.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/laboratories.js') }}"></script>
    <script>
