...
@endpush
@section('title') {{__('Allowance types list')}} @endsection
@section('content')
    @component('components.dashboard.breadcrumb')
        @slot('breadcrumb_title')
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("Allowance types") }}</h1><!-- end   :: Title -->
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('Allowance types list')}}</li><!-- end   :: Item -->
    @endcomponent
    ...
    <div class="card mb-2">
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                @can('create_allowance_types')
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.allowance-types.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">
                        <span class="svg-icon svg-icon-2">
                            <i class="fa fa-plus fa-lg"></i>
                        </span>
                        {{ __("Add new allowance type") }}
                   </a><!-- end   :: Add Button -->
                @endcan
                </div><!-- end   :: Toolbar -->
            </div><!-- end   :: Filter -->
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/allowance-types.js') }}"></script>
    <script>
