...
@endpush
@section('title') {{ __("deduction / addition list") }} @endsection
@section('content')

    @component('components.dashboard.breadcrumb')
        @slot('breadcrumb_title')
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("deduction / addition") }}</h1><!-- end   :: Title -->
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{ __("deduction / addition list") }}</li><!-- end   :: Item -->
    @endcomponent
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    @can('create_deduction_and_additions')
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.deduction-and-additions.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">

                        <span class="svg-icon svg-icon-2">
                            <i class="fa fa-plus fa-lg"></i>
                        </span>

                        {{ __("Add new deduction / addition") }}
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/deduction-and-additions.js') }}"></script>
    <script>
