...
@endpush
@section('title') {{__('Add new patient')}} @endsection
@section('content')
    @component('components.dashboard.breadcrumb')
        ...
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('Add new patient')}}</li><!-- end   :: Item -->
    @endcomponent
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-body">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.patients.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.patients.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center p-5">
                    <h3 class="fw-bolder text-dark">{{ __("Add new patient") }}</h3>
                </div><!-- end   :: Card header -->
