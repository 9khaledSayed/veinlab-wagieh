...
@section('content')
    @component('components.dashboard.breadcrumb')
        @slot('breadcrumb_title')
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("Patients") }}</h1><!-- end   :: Title -->
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('Patients list')}}</li><!-- end   :: Item -->
    @endcomponent
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    @can('create_patients')
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.patients.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">
            ...
            <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5">
                ...
                <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th>{{ __("Email") }}</th>
                    <th>{{ __("Gender") }}</th>
                    <th>{{ __("All Finished WaitingLab") }}</th>
                    <th>{{ __("All Pending WaitingLab") }}</th>
                    <th>{{ __("All WaitingLab") }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/patients.js') }}"></script>
    <script>
