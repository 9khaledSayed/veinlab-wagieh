                        ...
                        <div id="text-header-info">
                            <div>
                                ...
                                <div style="display:inline-block;">
                                    ...
                                    <span>Gender : </span>
                                    <span>{{$invoice->patient->gender ?? ''}}</span>
                    ...
                    <div id="Analyis_title">
                        <div>
                            <h1 style="font-size:45px; color: #07804a">
                                {{$waitingLab->mainAnalysis->general_name ?? ''}} </h1>
                        </div>
                    </div>
                        ...
                        <table style="font-size:20px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @else
                                    <td class="text-start">Not found Normal Ranges</td>
                                    @endif
                        ...
                        <table style="font-size: 25px">
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$moderateSensitiveTo['name']}}</td>
                                    @endforeach
                                </tr>
                            </tbody>
                        </table>
