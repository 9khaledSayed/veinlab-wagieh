...
@endpush
@section('title') {{__('All Results')}} @endsection
@section('content')
@component('components.dashboard.breadcrumb')
    ...
    @endslot
    <!-- begin :: Item -->
    <li class="breadcrumb-item text-muted">{{__('Results list')}}</li><!-- end   :: Item -->
@endcomponent

<!-- begin :: Datatable card -->
<div class="card mb-2">
    <!-- begin :: Card Body -->
    <div class="card-body  py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
        <!-- begin :: Filter -->
        <div class=" flex-stack flex-wrap mb-15">
...
<script src="{{ asset('js/dashboard/datatables/result.js') }}"></script>
<script>
