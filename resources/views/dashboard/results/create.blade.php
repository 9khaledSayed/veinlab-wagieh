...
@section('title')  {{ __("Create Result") }} @endsection
...
<form action="{{'/dashboard/results?waiting_lab_id=' . $waitingLab->id}}" id="submitted-form" data-redirection-url="{{url(url()->previous())}}" class="form" method="post">
    @csrf
