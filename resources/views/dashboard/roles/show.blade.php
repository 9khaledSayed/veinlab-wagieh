...
@endpush
@section('title') {{ __("Role data") }} @endsection

@section('content')
    @component('components.dashboard.breadcrumb')
        @slot('breadcrumb_title')
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.roles.index') }}" class="text-muted text-hover-primary">{{ __("Roles") }}</a></h1>
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('Roles data')}}</li><!-- end   :: Item -->
    @endcomponent
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                                    ...
                                                    @foreach( $modules as $module)
                                                        ...
                                                        <tr>
                                                            <!--begin::Label-->
                                                            <td class="text-gray-800"> {{ __((str_replace("_", " " , ucwords( $module ))))  }} </td>
                                                            <!--end::Label-->
                                                            <!--begin::Input group-->
                                                            <td>
                                                                <!--begin::Wrapper-->
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready( () => {
            ...
            new Tagify( document.getElementById('name_ar_inp_edit') , { originalInputValueFormat: valuesArr => valuesArr.map(item => item.value).join(',') });
            new Tagify( document.getElementById('name_en_inp_edit') , { originalInputValueFormat: valuesArr => valuesArr.map(item => item.value).join(',') });
