...
return [
    ...
    */
    ...
    'custom' => [
        'colors.*.inner_images' => [
            'required' => 'inner images are required'
        ],
        'abilities' => [
            'required' => 'The abilities are required'
        ],
        'colors.*.outer_images' => [
            'required' => 'outer images are required'
        ],
        'hex_code' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'meta_tag_description_ar' => 'meta tag description arabic',
        'meta_tag_description_en' => 'meta tag description english',
        'meta_tag_keyword_ar' => 'meta tag keyword arabic',
        'meta_tag_keyword_en' => 'meta tag keyword english',
